...
def save_consumer_info(consumer_key, consumer_secret):
    """Save consumer key and consumer secret."""
    q = ConsumerModel.all()
    for r in q:
        db.delete(r)

    consumer = ConsumerModel(consumer_key=consumer_key,
                             consumer_secret=consumer_secret)
    consumer.put()

def get_consumer_info():
    """Get consumer key and consumer secret."""
    res = ConsumerModel.all().get()
    return res.consumer_key, res.consumer_secret
