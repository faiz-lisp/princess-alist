...
gtap_message = """
    <html>
        ...
        <body><h2>GTAP v#gtap_version# is running!</h2>
        <h3>Step 1:</h3>
        <form action="/oauth/consumer" method="post">
            <table border="0">
                <tr>
                    <td align="right">Consumer Key:</td>
                    <td><input type="text" name="consumer_key" size="40" /></td>
                </tr>
                <tr>
                    <td align="right">Consumer Secret:</td>
                    <td><input type="text" name="consumer_secret" size="40" /></td>
                </tr>
                <tr>
                    <td></td>
        ...
        <h3>Step 2:</h3>
        <p><a href='/oauth/session'><img src='/images/sign-in-with-twitter.png' border='0'></a> <== Need Fuck GFW First!! 
